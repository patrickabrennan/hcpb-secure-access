...
variable "create_kv_mount"      { type = bool,   default = false }
variable "vault_kv_mount_path"  { type = string, default = "kv" }
variable "vault_kv_secret_path" { type = string, default = "boundary/rdp/svc" }
